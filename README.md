...
- [Windows x64](https://github.com/mochaman/alhena/releases/download/v5.4.7/alhena-5.4.7_windows_x64.zip) MSI installer
- [MacOS aarch64](https://github.com/mochaman/alhena/releases/download/v5.4.7/alhena-5.4.7_aarch64.dmg) DMG  (unsigned)
- [MacOS x64](https://github.com/mochaman/alhena/releases/download/v5.4.7/alhena-5.4.7_x64.dmg) DMG (unsigned)
